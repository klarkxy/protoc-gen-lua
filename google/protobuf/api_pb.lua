...
registry.RegistMessage(google_protobuf_api_pb.Api)
...
registry.RegistMessage(google_protobuf_api_pb.Method)
...
registry.RegistMessage(google_protobuf_api_pb.Mixin)
